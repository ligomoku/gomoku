...
export declare const GameCreator: {
    ({ isOpen, onClose, onCreate, isLoading, }: GameCreatorProps): import("react/jsx-runtime").JSX.Element;
    displayName: string;
};
...
export declare const GameCreatorButton: ({ children, timeControl, onCreateGame, isLoading, }: GameCreatorButtonProps) => import("react/jsx-runtime").JSX.Element;
