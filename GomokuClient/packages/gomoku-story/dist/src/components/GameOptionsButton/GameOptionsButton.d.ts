...
export declare const GameOptionsButtons: ({ onCreateGame, onPlayWithFriendClick, onPlayWithAIClick, createGameText, playWithFriendText, playWithAIText, isLoadingCreateGame, isLoadingPlayWithFriend, isLoadingPlayWithAI, }: GameOptionsButtonsProps) => import("react/jsx-runtime").JSX.Element;
