...
import type {
  PostGamehubRegisteredSendmessageMutationResponse,
  PostGamehubRegisteredSendmessageQueryParams,
} from "../models/PostGamehubRegisteredSendmessage";
import type { UseMutationOptions } from "@tanstack/react-query";

type PostGamehubRegisteredSendmessageClient = typeof client<
  PostGamehubRegisteredSendmessageMutationResponse,
  Error,
  never
>;
 ...
 */
export function usePostGamehubRegisteredSendmessage(
  params?: PostGamehubRegisteredSendmessage["queryParams"],
  options: {
    mutation?: UseMutationOptions<
      PostGamehubRegisteredSendmessage["response"],
      PostGamehubRegisteredSendmessage["error"],
      PostGamehubRegisteredSendmessage["request"]
    >;
  ...
  return useMutation({
    mutationFn: async () => {
      const res = await client<
        PostGamehubRegisteredSendmessage["data"],
        PostGamehubRegisteredSendmessage["error"],
        PostGamehubRegisteredSendmessage["request"]
      >({
        method: "post",
