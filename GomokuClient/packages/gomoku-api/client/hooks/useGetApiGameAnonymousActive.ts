...
export function getApiGameAnonymousActiveQueryOptions(params?: GetApiGameAnonymousActive["queryParams"], headers?: GetApiGameAnonymousActive["headerParams"], options: GetApiGameAnonymousActive["client"]["parameters"] = {}) {
 ...
 */
export function useGetApiGameAnonymousActive<TData = GetApiGameAnonymousActive["response"], TQueryData = GetApiGameAnonymousActive["response"], TQueryKey extends QueryKey = GetApiGameAnonymousActiveQueryKey>(params?: GetApiGameAnonymousActive["queryParams"], headers?: GetApiGameAnonymousActive["headerParams"], options: {
    ...
    const query = useQuery({
        ...getApiGameAnonymousActiveQueryOptions(params, headers, clientOptions) as unknown as QueryObserverOptions,
        queryKey,
...
export function getApiGameAnonymousActiveSuspenseQueryOptions(params?: GetApiGameAnonymousActive["queryParams"], headers?: GetApiGameAnonymousActive["headerParams"], options: GetApiGameAnonymousActive["client"]["parameters"] = {}) {
 ...
 * @link /api/game/anonymous/active
 */
export function useGetApiGameAnonymousActiveSuspense<TData = GetApiGameAnonymousActive["response"], TQueryKey extends QueryKey = GetApiGameAnonymousActiveSuspenseQueryKey>(params?: GetApiGameAnonymousActive["queryParams"], headers?: GetApiGameAnonymousActive["headerParams"], options: {
    ...
    const query = useSuspenseQuery({
        ...getApiGameAnonymousActiveSuspenseQueryOptions(params, headers, clientOptions) as unknown as UseSuspenseQueryOptions,
        queryKey,
