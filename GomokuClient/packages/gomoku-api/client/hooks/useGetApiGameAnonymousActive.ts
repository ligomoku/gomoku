...
import type {
  GetApiGameAnonymousActiveQueryResponse,
  GetApiGameAnonymousActiveQueryParams,
  GetApiGameAnonymousActiveHeaderParams,
} from "../models/GetApiGameAnonymousActive";
import type {
...
type GetApiGameAnonymousActiveClient = typeof client<
  GetApiGameAnonymousActiveQueryResponse,
  Error,
  never
>;
...
export const getApiGameAnonymousActiveQueryKey = (
  ...
  [{ url: "/api/game/anonymous/active" }, ...(params ? [params] : [])] as const;
export type GetApiGameAnonymousActiveQueryKey = ReturnType<
  ...
  return queryOptions({
    ...
    queryFn: async () => {
      const res = await client<
        GetApiGameAnonymousActive["data"],
        GetApiGameAnonymousActive["error"]
      >({
        method: "get",
 ...
 */
export function useGetApiGameAnonymousActive<
...
>(
  ...
  options: {
    query?: Partial<
      QueryObserverOptions<
        GetApiGameAnonymousActive["response"],
        GetApiGameAnonymousActive["error"],
        TData,
        TQueryData,
        TQueryKey
...
export const getApiGameAnonymousActiveSuspenseQueryKey = (
  params?: GetApiGameAnonymousActive["queryParams"],
) =>
  [{ url: "/api/game/anonymous/active" }, ...(params ? [params] : [])] as const;
export type GetApiGameAnonymousActiveSuspenseQueryKey = ReturnType<
 ...
 * @link /api/game/anonymous/active
 */
export function useGetApiGameAnonymousActiveSuspense<
  TData = GetApiGameAnonymousActive["response"],
