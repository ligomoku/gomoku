...
import type { UseMutationOptions } from "@tanstack/react-query";
 ...
 type PostGamehubAnonymousApproveundoClient = typeof client<PostGamehubAnonymousApproveundoMutationResponse, Error, never>;
 ...
 */
export function usePostGamehubAnonymousApproveundo(params?: PostGamehubAnonymousApproveundo["queryParams"], options: {
    mutation?: UseMutationOptions<PostGamehubAnonymousApproveundo["response"], PostGamehubAnonymousApproveundo["error"], PostGamehubAnonymousApproveundo["request"]>;
    client?: PostGamehubAnonymousApproveundo["client"]["parameters"];
} = {}) {
    const { mutation: mutationOptions, client: clientOptions = {} } = options ?? {};
    return useMutation({
        mutationFn: async () => {
            const res = await client<PostGamehubAnonymousApproveundo["data"], PostGamehubAnonymousApproveundo["error"], PostGamehubAnonymousApproveundo["request"]>({
                method: "post",
