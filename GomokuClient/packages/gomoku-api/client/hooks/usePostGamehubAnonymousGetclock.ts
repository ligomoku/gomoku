...
import type {
  PostGamehubAnonymousGetclockMutationResponse,
  PostGamehubAnonymousGetclockQueryParams,
} from "../models/PostGamehubAnonymousGetclock";
import type { UseMutationOptions } from "@tanstack/react-query";

type PostGamehubAnonymousGetclockClient = typeof client<
  PostGamehubAnonymousGetclockMutationResponse,
  Error,
  never
>;
 ...
 */
export function usePostGamehubAnonymousGetclock(
  params?: PostGamehubAnonymousGetclock["queryParams"],
  options: {
    mutation?: UseMutationOptions<
      PostGamehubAnonymousGetclock["response"],
      PostGamehubAnonymousGetclock["error"],
      PostGamehubAnonymousGetclock["request"]
    >;
  ...
  return useMutation({
    mutationFn: async () => {
      const res = await client<
        PostGamehubAnonymousGetclock["data"],
        PostGamehubAnonymousGetclock["error"],
        PostGamehubAnonymousGetclock["request"]
      >({
        method: "post",
