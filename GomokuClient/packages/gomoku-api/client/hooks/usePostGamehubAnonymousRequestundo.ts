...
import type { UseMutationOptions } from "@tanstack/react-query";
 ...
 type PostGamehubAnonymousRequestundoClient = typeof client<PostGamehubAnonymousRequestundoMutationResponse, Error, never>;
 ...
 */
export function usePostGamehubAnonymousRequestundo(params?: PostGamehubAnonymousRequestundo["queryParams"], options: {
    mutation?: UseMutationOptions<PostGamehubAnonymousRequestundo["response"], PostGamehubAnonymousRequestundo["error"], PostGamehubAnonymousRequestundo["request"]>;
    client?: PostGamehubAnonymousRequestundo["client"]["parameters"];
} = {}) {
    const { mutation: mutationOptions, client: clientOptions = {} } = options ?? {};
    return useMutation({
        mutationFn: async () => {
            const res = await client<PostGamehubAnonymousRequestundo["data"], PostGamehubAnonymousRequestundo["error"], PostGamehubAnonymousRequestundo["request"]>({
                method: "post",
