...
import type {
  PostApiGameAnonymousMutationRequest,
  PostApiGameAnonymousMutationResponse,
  PostApiGameAnonymousHeaderParams,
  PostApiGameAnonymous400,
} from "../models/PostApiGameAnonymous";
import type { UseMutationOptions } from "@tanstack/react-query";

type PostApiGameAnonymousClient = typeof client<
  PostApiGameAnonymousMutationResponse,
  PostApiGameAnonymous400,
  PostApiGameAnonymousMutationRequest
>;
...
export function usePostApiGameAnonymous(
  ...
  options: {
    mutation?: UseMutationOptions<
      ...
      PostApiGameAnonymous["error"],
      PostApiGameAnonymous["request"]
    >;
