...
export function getHealthQueryOptions(headers: GetHealth["headerParams"], options: GetHealth["client"]["parameters"] = {}) {
 ...
 * @link /health
 */
export function useGetHealth<TData = GetHealth["response"], TQueryData = GetHealth["response"], TQueryKey extends QueryKey = GetHealthQueryKey>(headers: GetHealth["headerParams"], options: {
    query?: Partial<QueryObserverOptions<GetHealth["response"], GetHealth["error"], TData, TQueryData, TQueryKey>>;
    ...
    const query = useQuery({
        ...getHealthQueryOptions(headers, clientOptions) as unknown as QueryObserverOptions,
        queryKey,
...
export function getHealthSuspenseQueryOptions(headers: GetHealth["headerParams"], options: GetHealth["client"]["parameters"] = {}) {
 ...
 * @link /health
 */
export function useGetHealthSuspense<TData = GetHealth["response"], TQueryKey extends QueryKey = GetHealthSuspenseQueryKey>(headers: GetHealth["headerParams"], options: {
    query?: Partial<UseSuspenseQueryOptions<GetHealth["response"], GetHealth["error"], TData, TQueryKey>>;
    client?: GetHealth["client"]["parameters"];
    ...
    const query = useSuspenseQuery({
        ...getHealthSuspenseQueryOptions(headers, clientOptions) as unknown as UseSuspenseQueryOptions,
        queryKey,
