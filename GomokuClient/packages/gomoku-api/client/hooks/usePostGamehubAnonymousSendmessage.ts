...
import type {
  PostGamehubAnonymousSendmessageMutationResponse,
  PostGamehubAnonymousSendmessageQueryParams,
} from "../models/PostGamehubAnonymousSendmessage";
import type { UseMutationOptions } from "@tanstack/react-query";

type PostGamehubAnonymousSendmessageClient = typeof client<
  PostGamehubAnonymousSendmessageMutationResponse,
  Error,
  never
>;
 ...
 */
export function usePostGamehubAnonymousSendmessage(
  params?: PostGamehubAnonymousSendmessage["queryParams"],
  options: {
    mutation?: UseMutationOptions<
      PostGamehubAnonymousSendmessage["response"],
      PostGamehubAnonymousSendmessage["error"],
      PostGamehubAnonymousSendmessage["request"]
    >;
  ...
  return useMutation({
    mutationFn: async () => {
      const res = await client<
        PostGamehubAnonymousSendmessage["data"],
        PostGamehubAnonymousSendmessage["error"],
        PostGamehubAnonymousSendmessage["request"]
      >({
        method: "post",
