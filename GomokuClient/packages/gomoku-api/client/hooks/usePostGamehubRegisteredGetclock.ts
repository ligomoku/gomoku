...
import type { UseMutationOptions } from "@tanstack/react-query";
 ...
 type PostGamehubRegisteredGetclockClient = typeof client<PostGamehubRegisteredGetclockMutationResponse, Error, never>;
 ...
 */
export function usePostGamehubRegisteredGetclock(params?: PostGamehubRegisteredGetclock["queryParams"], options: {
    mutation?: UseMutationOptions<PostGamehubRegisteredGetclock["response"], PostGamehubRegisteredGetclock["error"], PostGamehubRegisteredGetclock["request"]>;
    client?: PostGamehubRegisteredGetclock["client"]["parameters"];
} = {}) {
    const { mutation: mutationOptions, client: clientOptions = {} } = options ?? {};
    return useMutation({
        mutationFn: async () => {
            const res = await client<PostGamehubRegisteredGetclock["data"], PostGamehubRegisteredGetclock["error"], PostGamehubRegisteredGetclock["request"]>({
                method: "post",
