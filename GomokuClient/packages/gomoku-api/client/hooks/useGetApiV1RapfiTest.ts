...
import type { QueryObserverOptions, UseQueryResult, QueryKey, UseSuspenseQueryOptions, UseSuspenseQueryResult } from "@tanstack/react-query";
 ...
 type GetApiV1RapfiTestClient = typeof client<GetApiV1RapfiTestQueryResponse, GetApiV1RapfiTest500, never>;
...
export function getApiV1RapfiTestQueryOptions(headers: GetApiV1RapfiTest["headerParams"], options: GetApiV1RapfiTest["client"]["parameters"] = {}) {
    const queryKey = getApiV1RapfiTestQueryKey();
    return queryOptions({
        queryKey,
        queryFn: async () => {
            const res = await client<GetApiV1RapfiTest["data"], GetApiV1RapfiTest["error"]>({
                method: "get",
 ...
 */
export function useGetApiV1RapfiTest<TData = GetApiV1RapfiTest["response"], TQueryData = GetApiV1RapfiTest["response"], TQueryKey extends QueryKey = GetApiV1RapfiTestQueryKey>(headers: GetApiV1RapfiTest["headerParams"], options: {
    query?: Partial<QueryObserverOptions<GetApiV1RapfiTest["response"], GetApiV1RapfiTest["error"], TData, TQueryData, TQueryKey>>;
    ...
    const query = useQuery({
        ...getApiV1RapfiTestQueryOptions(headers, clientOptions) as unknown as QueryObserverOptions,
        queryKey,
...
export function getApiV1RapfiTestSuspenseQueryOptions(headers: GetApiV1RapfiTest["headerParams"], options: GetApiV1RapfiTest["client"]["parameters"] = {}) {
 ...
 * @link /api/v1/rapfi/test
 */
export function useGetApiV1RapfiTestSuspense<TData = GetApiV1RapfiTest["response"], TQueryKey extends QueryKey = GetApiV1RapfiTestSuspenseQueryKey>(headers: GetApiV1RapfiTest["headerParams"], options: {
    query?: Partial<UseSuspenseQueryOptions<GetApiV1RapfiTest["response"], GetApiV1RapfiTest["error"], TData, TQueryKey>>;
    client?: GetApiV1RapfiTest["client"]["parameters"];
    ...
    const query = useSuspenseQuery({
        ...getApiV1RapfiTestSuspenseQueryOptions(headers, clientOptions) as unknown as UseSuspenseQueryOptions,
        queryKey,
