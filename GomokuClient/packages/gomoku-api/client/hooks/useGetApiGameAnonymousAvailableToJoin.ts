...
export function getApiGameAnonymousAvailableToJoinQueryOptions(params?: GetApiGameAnonymousAvailableToJoin["queryParams"], headers?: GetApiGameAnonymousAvailableToJoin["headerParams"], options: GetApiGameAnonymousAvailableToJoin["client"]["parameters"] = {}) {
 ...
 */
export function useGetApiGameAnonymousAvailableToJoin<TData = GetApiGameAnonymousAvailableToJoin["response"], TQueryData = GetApiGameAnonymousAvailableToJoin["response"], TQueryKey extends QueryKey = GetApiGameAnonymousAvailableToJoinQueryKey>(params?: GetApiGameAnonymousAvailableToJoin["queryParams"], headers?: GetApiGameAnonymousAvailableToJoin["headerParams"], options: {
    ...
    const query = useQuery({
        ...getApiGameAnonymousAvailableToJoinQueryOptions(params, headers, clientOptions) as unknown as QueryObserverOptions,
        queryKey,
...
export function getApiGameAnonymousAvailableToJoinSuspenseQueryOptions(params?: GetApiGameAnonymousAvailableToJoin["queryParams"], headers?: GetApiGameAnonymousAvailableToJoin["headerParams"], options: GetApiGameAnonymousAvailableToJoin["client"]["parameters"] = {}) {
 ...
 * @link /api/game/anonymous/available-to-join
 */
export function useGetApiGameAnonymousAvailableToJoinSuspense<TData = GetApiGameAnonymousAvailableToJoin["response"], TQueryKey extends QueryKey = GetApiGameAnonymousAvailableToJoinSuspenseQueryKey>(params?: GetApiGameAnonymousAvailableToJoin["queryParams"], headers?: GetApiGameAnonymousAvailableToJoin["headerParams"], options: {
    ...
    const query = useSuspenseQuery({
        ...getApiGameAnonymousAvailableToJoinSuspenseQueryOptions(params, headers, clientOptions) as unknown as UseSuspenseQueryOptions,
        queryKey,
