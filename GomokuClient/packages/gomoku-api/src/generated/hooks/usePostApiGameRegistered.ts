...
import type {
  PostApiGameRegisteredMutationRequest,
  PostApiGameRegisteredMutationResponse,
  PostApiGameRegisteredHeaderParams,
  PostApiGameRegistered400,
} from "../models/PostApiGameRegistered";
import type { UseMutationOptions } from "@tanstack/react-query";

type PostApiGameRegisteredClient = typeof client<
  PostApiGameRegisteredMutationResponse,
  PostApiGameRegistered400,
  PostApiGameRegisteredMutationRequest
>;
 ...
 */
export function usePostApiGameRegistered(
  headers: PostApiGameRegistered["headerParams"],
  options: {
    mutation?: UseMutationOptions<
      PostApiGameRegistered["response"],
      PostApiGameRegistered["error"],
      PostApiGameRegistered["request"]
    >;
