...
import type {
  PostGamehubAnonymousMakemoveMutationResponse,
  PostGamehubAnonymousMakemoveQueryParams,
} from "../models/PostGamehubAnonymousMakemove";
import type { UseMutationOptions } from "@tanstack/react-query";

type PostGamehubAnonymousMakemoveClient = typeof client<
  PostGamehubAnonymousMakemoveMutationResponse,
  Error,
  never
>;
 ...
 */
export function usePostGamehubAnonymousMakemove(
  params?: PostGamehubAnonymousMakemove["queryParams"],
  options: {
    mutation?: UseMutationOptions<
      PostGamehubAnonymousMakemove["response"],
      PostGamehubAnonymousMakemove["error"],
      PostGamehubAnonymousMakemove["request"]
    >;
  ...
  return useMutation({
    mutationFn: async () => {
      const res = await client<
        PostGamehubAnonymousMakemove["data"],
        PostGamehubAnonymousMakemove["error"],
        PostGamehubAnonymousMakemove["request"]
      >({
        method: "post",
