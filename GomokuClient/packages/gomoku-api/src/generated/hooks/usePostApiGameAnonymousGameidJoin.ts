...
import type {
  PostApiGameAnonymousGameidJoinMutationRequest,
  PostApiGameAnonymousGameidJoinMutationResponse,
  PostApiGameAnonymousGameidJoinPathParams,
  PostApiGameAnonymousGameidJoinHeaderParams,
  PostApiGameAnonymousGameidJoin404,
} from "../models/PostApiGameAnonymousGameidJoin";
import type { UseMutationOptions } from "@tanstack/react-query";

type PostApiGameAnonymousGameidJoinClient = typeof client<
  PostApiGameAnonymousGameidJoinMutationResponse,
  PostApiGameAnonymousGameidJoin404,
  PostApiGameAnonymousGameidJoinMutationRequest
>;
...
export function usePostApiGameAnonymousGameidJoin(
  ...
  options: {
    mutation?: UseMutationOptions<
      ...
      PostApiGameAnonymousGameidJoin["error"],
      PostApiGameAnonymousGameidJoin["request"]
    >;
  ...
  return useMutation({
    mutationFn: async (data) => {
      const res = await client<
        PostApiGameAnonymousGameidJoin["data"],
        PostApiGameAnonymousGameidJoin["error"],
        PostApiGameAnonymousGameidJoin["request"]
      >({
        method: "post",
