...
import type {
  PostGamehubAnonymousResignMutationResponse,
  PostGamehubAnonymousResignQueryParams,
} from "../models/PostGamehubAnonymousResign";
import type { UseMutationOptions } from "@tanstack/react-query";

type PostGamehubAnonymousResignClient = typeof client<
  PostGamehubAnonymousResignMutationResponse,
  Error,
  never
>;
 ...
 */
export function usePostGamehubAnonymousResign(
  params?: PostGamehubAnonymousResign["queryParams"],
  options: {
    mutation?: UseMutationOptions<
      PostGamehubAnonymousResign["response"],
      PostGamehubAnonymousResign["error"],
      PostGamehubAnonymousResign["request"]
    >;
  ...
  return useMutation({
    mutationFn: async () => {
      const res = await client<
        PostGamehubAnonymousResign["data"],
        PostGamehubAnonymousResign["error"],
        PostGamehubAnonymousResign["request"]
      >({
        method: "post",
