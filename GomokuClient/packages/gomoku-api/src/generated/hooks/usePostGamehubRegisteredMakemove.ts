...
import type {
  PostGamehubRegisteredMakemoveMutationResponse,
  PostGamehubRegisteredMakemoveQueryParams,
} from "../models/PostGamehubRegisteredMakemove";
import type { UseMutationOptions } from "@tanstack/react-query";

type PostGamehubRegisteredMakemoveClient = typeof client<
  PostGamehubRegisteredMakemoveMutationResponse,
  Error,
  never
>;
 ...
 */
export function usePostGamehubRegisteredMakemove(
  params?: PostGamehubRegisteredMakemove["queryParams"],
  options: {
    mutation?: UseMutationOptions<
      PostGamehubRegisteredMakemove["response"],
      PostGamehubRegisteredMakemove["error"],
      PostGamehubRegisteredMakemove["request"]
    >;
  ...
  return useMutation({
    mutationFn: async () => {
      const res = await client<
        PostGamehubRegisteredMakemove["data"],
        PostGamehubRegisteredMakemove["error"],
        PostGamehubRegisteredMakemove["request"]
      >({
        method: "post",
