...
import type {
  PostGamehubRegisteredResignMutationResponse,
  PostGamehubRegisteredResignQueryParams,
} from "../models/PostGamehubRegisteredResign";
import type { UseMutationOptions } from "@tanstack/react-query";

type PostGamehubRegisteredResignClient = typeof client<
  PostGamehubRegisteredResignMutationResponse,
  Error,
  never
>;
 ...
 */
export function usePostGamehubRegisteredResign(
  params?: PostGamehubRegisteredResign["queryParams"],
  options: {
    mutation?: UseMutationOptions<
      PostGamehubRegisteredResign["response"],
      PostGamehubRegisteredResign["error"],
      PostGamehubRegisteredResign["request"]
    >;
  ...
  return useMutation({
    mutationFn: async () => {
      const res = await client<
        PostGamehubRegisteredResign["data"],
        PostGamehubRegisteredResign["error"],
        PostGamehubRegisteredResign["request"]
      >({
        method: "post",
