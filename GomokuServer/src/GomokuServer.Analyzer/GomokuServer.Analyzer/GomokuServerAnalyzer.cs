...
//public class GomokuServerAnalyzer : DiagnosticAnalyzer
//{
...
//		messageFormat: "File should define classes in the following order: Comand or Query class, than Handler class.",
//		category: "Structure",
